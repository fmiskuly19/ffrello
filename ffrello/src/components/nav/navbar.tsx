...
import WorkspaceDropdown from './content/workspaceDropdown';
import RecentBoardsDropdown from './content/recentBoardsDropdown';
import StarredDropdown from './content/starredDropdown';
import TemplatesDropdownContent from './content/templatesDropdown';
import NotificationsNoneIcon from '@mui/icons-material/NotificationsNone';
import HelpOutlineIcon from '@mui/icons-material/HelpOutline';
import TonalityIcon from '@mui/icons-material/Tonality';
import ThemeDropdown from './content/themeDropdown';
import AppswitcherDropdown from './content/appswitcherDropdown';
import AppsIcon from '@mui/icons-material/Apps';
import { Link } from 'react-router-dom';
import InformationDropdown from './content/informationDropdown'
